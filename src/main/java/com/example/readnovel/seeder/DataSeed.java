...
//        }
        ...
        novelName.add("Imouto sae Ireba Ii");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s12084-45befb49-f4c4-42c9-86b7-d0e23a980557-m.jpg");

        novelName.add("Rebuild World");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s11059-c349b687-3bc1-41b4-aa5c-340cf13293e8-m.jpg");
        novelName.add("Saikyou Mahoushi no Inton Keikaku (LN)");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s12838-29eab5c1-67c1-4223-b5c3-9551edb21041-m.jpg");
        novelName.add("Tensei shitara doragon no tamago datta ~ saikyō igai mezasane ~e ~");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s447-f0a304f0-7ce4-4255-ad00-7b8a701614b6-m.jpg");
        novelName.add("Chẳng biết vì sao Nữ thần học đường lại thích ghé chơi nhà tôi");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s12397-080992b2-be0a-4b83-a863-085471bc4219-m.jpg");
        novelName.add("Kuro no Maou");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s9246-e3c75fec-e94f-48bd-a56f-140841bba6ba-m.jpg");
        novelName.add("Tiết kiệm 80000 đồng vàng ở thế giới khác để an dưỡng tuổi già.");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s7884-bb8e1a01-e8c1-4b31-95e6-f4ebfa55c2cc-m.jpg");
        novelName.add("Tớ sẽ đợi tại mùa xuân hôm qua");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s13054-ee329f71-aeef-47a6-9814-40171671025e-m.jpg");
        novelName.add("Những vai chính bị tiêu diệt bởi tôi");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s13256-ac8bb0fd-2eb3-4357-a3be-6c14c3a16d8a-m.jpg");
        novelName.add("Maou Gakuin no Futekigousha ~Shijou Saikyou no Maou no Shiso, Tensei shite Shison tachi no Gakkou e Kayou~");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s3601-c1361136-16b0-4692-b703-c8a5e0da67a0-m.jpg");
        novelName.add("Ankoku kishi monogatari~Yuusha wo taosu tameni Maou ni Shoukansaremashita~");
        novelThumbnail.add("https://1.bp.blogspot.com/-jsg56dTB53k/W1wc_p_s_aI/AAAAAAABdOQ/32a5iUJULiwmuxDtz2xqjwrl2BsL1dxxgCHMYCw/w215/default.jpg");
        novelName.add("Ichioku-nen Button o Renda Shita Ore wa, Kizuitara Saikyou ni Natteita~Rakudai Kenshi no Gakuin Musou~");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s6099-5f8fc116-0122-453c-914f-9ac03cc6dee5-m.jpg");
        novelName.add("The Death Mage Who Doesn't Want A Fourth Time");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s12217-077c5170-dbce-4fae-a215-49028288e266-m.jpg");
        novelName.add("Kono Subarashii Sekai Ni Shukufuku o!");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s7048-c3cfc9bb-4d42-4b74-94ab-a06652cbf581-m.jpg");
        novelName.add("Mushoku Tensei - Isekai Ittara Honki Dasu");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s139-e57efbf8-0c46-4f8f-8287-9aa586c555c6-m.jpg");
        novelName.add("Arafoo Kenja No Isekai Seikatsu Nikki");
        novelThumbnail.add("https://i.docln.net/lightnovel/covers/s3838-2f4279f7-6dad-41e0-99d1-592c760f850d-m.jpg");

        for (int i = 0; i < novelName.size(); i++) {
            saveNovel(novelName.get(i), novelThumbnail.get(i));
        }
    }

    private void saveNovel(String novelName, String img) {
        Account account = accountRepository.findByUsername("admin").get();
        String authorName = faker.name().name();
        Optional<Author> optAuthor = authorRepository.findByName(authorName);
        String artistName = faker.name().name();
        Optional<Artist> optionalArtist = artistRepository.findByName(artistName);
        Author author = optAuthor.orElseGet(() -> authorRepository.save(Author.builder().name(authorName).build()));
        Artist artist = optionalArtist.orElseGet(() -> artistRepository.save(Artist.builder().name(artistName).build()));
...
///Volume
        ...
        for (int i = 0; i < faker.random().nextInt(2, 5); i++) {
            int count = i + 1;
            volumes.add(Volume.builder().title("Tập " + count).number(i).novel(novel).build());
    ...
    private void saveChapter(Volume vol) {
    ...
    private List<Type> getRandomType() {
        List<Type> types = typeRepository.findAll();
        List<Type> typesReturn = new ArrayList<>();
        for (int i = 0; i < faker.random().nextInt(7, 10); i++) {
            Type type = getRandomElement(types);
            if (!typesReturn.contains(type)) {
    ...
    public Type getRandomElement(List<Type> list) {
...
//        faker.random().
        ...
        Author densuke = authorRepository.findByName("Densuke").get();
        Artist ban = artistRepository.findByName("Ban").get();
        Novel novel = Novel.builder()
                .avatar("https://i.docln.net/lightnovel/covers/s12217-077c5170-dbce-4fae-a215-49028288e266-m.jpg")
                .name("Yondome wa Iyana Shi Zokusei Majutsushi test")
                .otherName("The Death Mage Who Doesn't Want A Fourth Time")
                .typeOfStory(TypeOfStory.TRANSLATION)
                .summary("<p>Một vụ tai nạn thương tâm khiến cho hơn một trăm người xấu số bỏ mạng. Khi tất cả tỉnh dậy, họ được vị thần luân hồi đề nghị tái sinh sang thế giới khác.</p>\n" +
                        "<p>Amamiya Hiroto, cậu học sinh nằm trong những người được tái sinh đã không may bị tái sinh khi chẳng nhận được chút sức mạnh nào. Để rồi cuộc đời thứ hai của cậu còn khốn khổ hơn cả kiếp trước.</p>\n" +
...
/// volume
        List<Volume> volumes = new ArrayList<>();
        volumes.add(Volume.builder().title("Tập 1").novel(novel).build());
        volumes.add(Volume.builder().title("Tập 2").novel(novel).build());
        volumes.add(Volume.builder().title("Tập 3").novel(novel).build());
        volumes.add(Volume.builder().title("Tập 4").novel(novel).build());
        volumes.add(Volume.builder().title("Tập 5").novel(novel).build());
        volumes = volumeRepository.saveAll(volumes);
        //chapter
        Volume vol1 = volumes.get(0);

        novel.setLastUpdate(new Timestamp(System.currentTimeMillis()));
        novelRepository.save(novel);
    }

    private void addWhenNodata() {
        addRole();
        addTeamRole();
        addUser();
        addType();
